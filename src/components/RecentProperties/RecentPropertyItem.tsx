...
const RecentPropertyItem = ({
  ...
  data: RecentPropertyType;
}) => {
  return (
    <div className="relative flex flex-col w-full shadow-md text-sm">
      <div className="relative text-white overflow-hidden group/top">
        <a href="#" className="">
          <img
            src={backdrop}
            alt=""
        ...
        <div className="absolute bottom-0 left-0 w-full px-5 py-2 flex justify-between items-center bg-gradient-to-t from-black/70 to-transparent">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <a
                href="#"
                className="text-white font-medium hover:text-slate-200 duration-100"
              >
                {agent.name}
              </a>
              <a href="#" className=" hover:text-slate-200 duration-100">
                {agent.type}
              </a>
            </div>
          </div>
      ...
      <div className="py-8 px-7 bg-paper">
